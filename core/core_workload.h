...
namespace ycsbc
{
  ...
  public:
    ...
    virtual bool DoTransaction(DB &db, int client_id, long long start_time_ns);
  ...
  protected:
    ...
    DB::Status TransactionRandomInsert(DB &db, int client_id, std::string table_name, long long start_time_ns);
